...
2) a **hands-on analysis** using building morphology + environmental covariates to explore how **settlement types (clusters)** relate to **malaria test positivity (TPR)** in **Zango Ward, Kano (Nigeria)**.
